...
public class JsonTopeResponse {
    ...
    public JsonTopeResponse() {
        this.successful = false;
    }

    public JsonTopeResponse(JSONObject jo) {
        ...
        try {
            ...
            if(!ju.readAttr(JSON_RES_DATE).equals(""))
    ...
    public JsonTopeResponse(boolean successful, String statusCode, String command, String message, String requestId, String responseId, Date date) {
