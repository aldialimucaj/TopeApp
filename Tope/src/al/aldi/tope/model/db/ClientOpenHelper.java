...
public class ClientOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String  DB_CREATE_TABLE   = "CREATE TABLE " + CLIENT_TABLE_NAME + " (" + CLIENT_NAME + " TEXT, " + CLIENT_IP + " TEXT, " + CLIENT_PORT + " TEXT, " + CLIENT_ACTIVE + " TEXT, " + CLIENT_USER
                                                          + " TEXT, " + CLIENT_PASS + " TEXT, " + CLIENT_DOMAIN + " TEXT "
