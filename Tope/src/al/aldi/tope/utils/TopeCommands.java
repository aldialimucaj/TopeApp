...
public class TopeCommands {
    ...
    public static final String OS_HIBERNATE = "/os/hibernate";
    public static final String OS_LOG_OFF = "/os/logOffPC";
    public static final String OS_POWER_OFF = "/os/powerOffPC";
    ...
    public static final String OS_SOUND_OFF = "/os/soundOn";
